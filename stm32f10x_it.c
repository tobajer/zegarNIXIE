...
uint16_t melodia5[]={
		2000,
		/*a1,4,g1,8,f1,8,g1,8,a1,8,c1,4, a1,4,g1,8,f1,8,g1,8,a1,8,d1,4, a1,4,a1,8,b1,8,c2,4,b1,8,a1,8, g1,2,a1,4,g1,4,
		f1,4,e1,8,d1,8,e1,8,f1,8,a0,4, 1,8,f1,8,e1,8,d1,8,e1,8,f1,8,b0,4, 1,8,f1,8,f1,8,g1,8,a1,4,g1,8,f1,8, g1,2,1,2,
		refren*/
		a1,4,g1,8,f1,8,g1,8,a1,8,c1,4, 1,8,a1,8,g1,8,f1,8,g1,8,a1,8,d1,4, 1,8,a1,8,a1,8,b1,8,c2,8,b1,8,a1,8, g1,2,a1,4,g1,4, f1,4,e1,8,d1,8,e1,8,f1,8,a0,4, 1,8,f1,8,e1,8,d1,8,e1,8,f1,8,b0,4,
		f1,4,f1,8,g1,8,a1,4,g1,8,f1,8, g1,2,1,2,

		a1,4,g1,8,f1,8,g1,8,a1,8,c1,4, 1,8,a1,8,g1,8,f1,8,g1,8,a1,8,d1,4, 1,8,a1,8,a1,8,b1,8,c2,8,b1,8,a1,8, g1,2,a1,4,g1,4, f1,4,e1,8,d1,8,e1,8,f1,8,a0,4, 1,8,f1,8,e1,8,d1,8,e1,8,f1,8,b0,4,
		f1,4,f1,8,g1,8,a1,4,g1,8,f1,8, g1,2,1,8,
		e1,8,f1,8,d1,1,
		end};
/*Or³a cien, Various Manx*/
uint16_t melodia6[]={
		3000,
		c1,16,e1,16,g1,8,1,16,a1,4,1,16,g1,8,g1,8,1,2,  c1,16,e1,16,g1,8,1,16, a1,4,1,8,h1,4,a1,8,g1,8,e1,2,1,16, e1,8,d1,8,c1,2,1,16,e1,8,d1,8,c1,2,1,8, a0,16,e1,8,d1,8, c1,8,e1,4,d1,4,c1,4, c1,2,1,2,
		c1,16,e1,16,g1,8,1,16,a1,4,1,16,g1,8,g1,8,1,2,  c1,16,e1,16,g1,8,1,16, a1,4,1,8,h1,4,a1,8,g1,8,e1,2,1,16, e1,8,d1,8,c1,2,1,16,e1,8,d1,8,c1,2,1,8, a0,16,e1,8,d1,8, c1,8,e1,4,d1,4,c1,4, c1,2,1,2,
		end
		};
...
uint16_t melodia7[]={
	2000,
	c1,8,c1,4,c1,8,f1,8,f1,4,f1,8,dis1,8,dis1,8,dis1,8,dis1,8,d1,4,1,4,
	c1,8,c1,4,c1,8,f1,8,f1,4,f1,8,dis1,8,dis1,8,dis1,8,g1,8,d1,4,
	g1,8,a1,8,b1,4,g1,4,dis1,4,1,4,b1,8,b1,16,b1,8,b1,16,b1,8,a1,4,1,8,
	g1,8,a1,8,b1,4,g1,4,dis1,4,1,4,b1,8,b1,16,b1,8,b1,16,b1,8,a1,4,1,8,
	g1,8,a1,8,b1,4,d2,4,dis2,4,1,4,d2,4,d2,4,b1,8,a1,4,1,16,
	g1,8,a1,8,b1,4,d2,4,dis2,4,1,4,d2,4,d2,4,b1,8,c2,4,1,16,
	d2,4,b1,4,c2,4,dis2,4,d2,8,d2,8,d2,8,b1,8,a1,4,1,4,
	d2,4,b1,4,c2,4,dis2,4,d2,8,d2,8,d2,8,b1,8,c2,4,1,4,
	c1,4,d1,4,dis1,2,c1,2,gis0,1,
	end
	};
...
uint16_t melodia8[]={
	1500,
	g1,8,g1,8,a1,8,a1,8,e1,8,e1,8,g1,4,
	g1,8,g1,8,a1,8,a1,8,e1,8,e1,8,g1,4,
	g1,8,g1,8,a1,4,c2,4,h1,4,h1,4,a1,4,g1,4,f1,4,
	f1,8,f1,8,g1,8,g1,8,d1,8,d1,8,f1,4,
	f1,8,f1,8,g1,8,g1,8,d1,8,d1,8,f1,4,
	f1,8,f1,8,g1,4,h1,4,a1,4,a1,4,g1,4,f1,4,e1,4,
	g1,8,g1,8,a1,8,a1,8,e1,8,e1,8,g1,4,
	g1,8,g1,8,a1,8,a1,8,e1,8,e1,8,g1,4,
	g1,8,g1,8,a1,4,c2,4,h1,4,h1,4,a1,4,g1,4,f1,4,
	f1,8,f1,8,g1,8,g1,8,d1,8,d1,8,f1,4,
	f1,8,f1,8,g1,8,g1,8,d1,8,d1,8,f1,4,
	g1,4,a1,4,h1,4,c2,4,a1,4,g1,4,e1,4,c1,4,
	g1,4,fis1,4,f1,4,e1,2,1,4,g1,4,e2,2,1,4,d2,4,d2,2,c2,2,
	c2,4,g1,4,fis1,4,f1,4,e1,2,1,4,g1,4,d2,2,1,4,c2,4,h1,1,
	h1,4,a1,4,g1,4,fis1,4,f1,2,1,4,g1,4,d2,2,1,4,c2,4,c2,2,
	h1,2,h1,4,d2,4,d2,4,c2,4,c2,2,h1,2,h1,4,h1,4,c2,4,d2,4,c2,1,
	end
	};

/*Oda do radosci - L.van Beethoven*/
uint16_t melodia9[]={
	2000,
	a1,4,a1,4,b1,4,c2,4,c2,4,b1,4,a1,4,g1,4,f1,4,f1,4,g1,4,a1,4,a1,4,1,8,g1,8,g1,2,
	a1,4,a1,4,b1,4,c2,4,c2,4,b1,4,a1,4,g1,4,f1,4,f1,4,g1,4,a1,4,g1,4,1,8,f1,8,f1,2,
	g1,4,g1,4,a1,4,f1,4,g1,4,a1,8,b1,8,a1,4,f1,4,g1,4,a1,8,b1,8,a1,4,g1,4,f1,4,g1,4,c1,4,a1,4,
	a1,4,a1,4,b1,4,c2,4,c2,4,b1,4,a1,4,b1,8,g1,8,f1,4,f1,4,g1,4,a1,4,g1,4,1,8,f1,8,f1,2,
	end
	};
...
uint16_t melodia10[]={
	2000,
	a1,8,1,16,b1,16,c2,4,c2,4,c2,8,1,16,a1,16,d2,8,c2,8,b1,8,a1,8,
	g1,8,1,16,g1,16,c2,4,1,8,b1,8,b1,4,a1,4,1,8,
	a1,8,1,16,b1,16,c2,4,c2,4,c2,8,1,16,a1,16,d2,8,c2,8,b1,8,a1,8,
	g1,8,1,16,g1,16,c2,4,1,8,e1,8,g1,4,f1,4,1,8,
	/*refren*/
	g1,4,g1,4,1,8,b1,8,b1,8,a1,8,a1,2,
	b1,8,1,16,b1,16,b1,4,b1,8,d2,8,d2,4,c2,2,
	a1,8,1,16,c2,16,f2,4,1,8,e2,8,e2,8,d2,8,d2,2,
	c2,8,c2,8,b1,4,1,8,e1,8,g1,4,f1,4,1,8,
	end
	};
...
uint16_t melodia11[]={
	2000,
	f1,4,gis1,8,1,16,f1,8,f1,16,b1,8,f1,8,dis1,8,f1,4,c2,8,1,16,f1,8,f1,16,cis2,8,c2,8,gis1,8,f1,8,c2,8,f2,8,f1,16,dis1,8,dis1,16,c1,8,g1,8,f1,8,f1,2,1,2,
	end
};
...
uint16_t melodia12[]={
	3000,
	g1,8,h1,8,d1,8,e1,8,g1,8,h0,8,d1,4,g1,8,fis1,8,e1,8,d1,8,g1,8,h1,8,d1,8,e1,8,g1,8,h0,8,d1,4,1,8,1,4,1,8,
	a1,8,h1,8,c2,8,e1,4,1,8,g1,4,1,8,1,4,1,8,a1,8,a1,8,c2,8,e1,4,1,8,g1,4,1,8,fis1,8,g1,8,a1,8,
	g1,8,h1,8,d1,8,e1,8,g1,8,h0,8,d1,4,g1,8,fis1,8,e1,8,d1,8,g1,8,h1,8,d1,8,e1,8,g1,8,h0,8,d1,4,1,8,1,4,1,8,
	a1,8,h1,8,c2,8,e1,4,1,8,g1,4,1,8,1,4,1,8,a1,8,a1,8,c2,8,e1,4,1,8,g1,4,1,8,g1,2,fis1,2,g1,2,1,8,
	end
};

/*ChodŸ pomaluj mój wiat / 2+1*/
uint16_t melodia13[]={
	4000,
	e1,8,g1,8,1,16,e1,16,e1,16,f1,16,g1,16,a1,4,1,8,c2,8,a1,8,g1,8,g1,16,g1,16,a1,16,e1,16,e1,16,d1,16,e1,16,g1,16,g1,16,a1,8,1,16,
	g1,16,g1,16,g1,8,g1,16,a1,16,a1,16,a1,8,a1,16,a1,16,a1,16,a1,16,a1,16,a1,16,a1,16,a1,16,a1,16,1,4,a1,18,g1,4,e1,8,g1,8,1,16,e1,16,e1,16,f1,16,g1,16,a1,16,a1,16,a1,8,1,16,a1,8,c2,8,
	a1,8,g1,8,g1,16,g1,16,g1,16,a1,16,e1,16,d1,16,e1,16,g1,16,g1,16,a1,8,1,16,1,8,g1,16,g1,16,g1,8,g1,16,a1,16,a1,16,a1,8,a1,16,a1,16,a1,16,a1,16,a1,16, a1,16,a1,16,a1,16,a1,16,1,4,a1,8,g1,4,1,8,
	end
};
...
uint16_t melodia14[]={
	1500,
	a1,8,c2,4,a1,8,c2,4,a1,4,e1,2,dis1,2,d1,8,g1,4,b1,8,d2,2,1,2,
	b1,4,d2,8,b1,8,d2,8,1,8,d1,8,a1,4,g1,4,fis1,4,g1,4,c2,4,1,4,
	a1,8,c2,4,a1,8,c2,4,a1,4,e1,2,dis1,2,d1,8,g1,4,b1,8,d2,2,1,2,
	b1,4,d2,8,b1,8,d2,8,1,8,d1,8,a1,4,g1,4,fis1,4,g1,4,c2,4,1,2,a1,2,f1,1,
	end
};
...
uint16_t melodia15[]={
	2000,
	g1,8,c1,4,g1,8,1,16,a1,16,h1,4,e1,8,e1,8,a1,4,g1,8,1,16,f1,16,g1,4,c1,8,1,16,c1,16,
	d1,4,d1,8,1,16,e1,16,f1,4,f1,8,g1,8,a1,4,h1,8,1,16,c2,16,d2,4,1,8,g1,8,e2,4,d2,8,1,16,c2,16,d2,4,h1,8,g1,8,
	c2,4,h1,8,1,16,a1,16,h1,4,e1,8,e1,8,a1,4,g1,8,1,16,f1,16,g1,4,c1,8,1,16,c1,16,c2,4,h1,8,1,16,a1,16,g1,2,
	e2,2,d2,8,c2,8,h1,8,c2,8,d2,4,1,8,g1,8,g1,2,c2,2,h1,8,a1,8,g1,8,a1,8,h1,4,1,8,e1,8,e1,2,c2,4,a1,8,1,16,h1,16,c2,4,a1,8,1,16,h1,16,
	c2,4,a1,8,1,16,c2,16,f2,2,f2,2,e2,8,d2,8,c2,8,d2,8,e2,4,1,8,c2,8,c2,2,d2,2,c2,8,h1,8,a1,8,h1,8,
	c2,4,1,8,a1,8,a1,2,c2,4,h1,8,a1,8,g1,4,c1,8,1,16,c1,16,	g1,2,a1,4,h1,4,c2,1,1,1,	/*c2,4,h1,8,1,16,a1,16,g1,8,1,1,*/
	end
};
...
uint16_t melodia16[]={
	5000,
	d1,8,c1,8,f1,8,e1,8,d1,8,c1,8,d1,8,f1,8,g1,8,f1,8,g1,8,a1,4,
	c2,8,d2,8,c2,8,a1,8,g1,8,f1,8,f1,4,f1,8,g1,8,a1,8,g1,8,e1,8,c1,8,d1,4,
	d2,8,c2,8,a1,8,g1,8,f1,8,g1,8,f1,8,g1,8,a1,8,c2,8,d2,8,c2,8,a1,8,g1,8,f1,4,
	c2,8,a1,8,g1,8,f1,8,f1,8,g1,8,a1,8,g1,8,e1,8,c1,8,d1,8,f1,8,g1,8,a1,8,g1,8,e1,8,c1,8,d1,2,
	end
};
//uint16_t melodia5[]={500, c0,1,cis0,1,d0,1,dis0,1,e0,1,f0,1,fis0,1,g0,1,gis0,1,a0,1,b0,1,h0,1,0,1,c1,1,cis1,1,d1,1,dis1,1,e1,1,f1,1,fis1,1,g1,1,gis1,1,a1,1,b1,1,h1,1,0,1,c2,1,cis2,1,d2,1,dis2,1,e2,1,f2,1,fis2,1,g2,1,gis2,1,a2,1,b2,1,h2,1,0,1,c3,1,cis3,1,d3,1,dis3,1,e3,1,f3,1,fis3,1,g3,1,end};
int32_t Muzyka;
#define LICZBA_MELODII	16//
uint16_t *melodie[LICZBA_MELODII+1]={0,melodia1,melodia2,melodia3,melodia4, melodia5, melodia6, melodia7, melodia8, melodia9, melodia10, melodia11, melodia12, melodia13, melodia14,melodia15,melodia16};
	...
	if (RTC_GetITStatus(RTC_IT_SEC) != RESET)
	{
			...
			)
		{
			   ...
			   )
			{
				...
				Muzyka = random8L(LICZBA_MELODII)+1;
				idx_nuta_dzwiek = 1;
...
//					RTC_SetCalendar(&RTC_ActualCallendarStruct);	//aktualizuj datê
				...
				case ODCZYT_ALARMU:
					...
					RTC_BudzikTemp.HOUR = RTC_Budzik[w].HOUR;
					RTC_BudzikTemp.MIN = RTC_Budzik[w].MIN;
					TimerOA = -1;
					TimerBNA = -1;
