...
void TIM_Configuration(void)
{
	...
	TIM_TimeBaseStruct.TIM_Prescaler = 1000 - 1;	//56MHz/1000 = 56000 Hz
	TIM_TimeBaseStruct.TIM_Period = 280 - 1;		//200Hz
	...
	TIM_DeInit(TIM2);
	TIM_TimeBaseStruct.TIM_Prescaler = 854 - 1;		//56MHz/854 = 65,574kHz
	...
	TIM_DeInit(TIM4);
	TIM_TimeBaseStruct.TIM_Prescaler = 56000 - 1;		//56MHz/56000 = 1 kHz
...
void RTC_Initialization(void)
{
	...
	if (BKP_ReadBackupRegister(BKP_DR1) != 0x1234)	//jesli zresetowane (zanik napiec VCC i BAT)
	{
		...
		BKP_SetRTCCalibrationValue(29);		//29 -> 31.10.2018 (kalibracja uzyskuj¹ca dok³adnoæ < 1ppm (~0.2ppm tj. ~0,5sec/month)
	...
	//	RTC_ITConfig(RTC_IT_ALR, ENABLE);	//wlacz przerwanie od alarmu
		...
		//z CALIBRATION=29 to bêdzie 32763,90625 cykla/sec
